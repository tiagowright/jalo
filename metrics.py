...
METRICS = [
    ...
    Metric(name="dist", description="euclidean distance squared", ngramType=NgramType.BIGRAM, function=distance_squared),
    Metric(name="dist_linear", description="euclidean distance", ngramType=NgramType.BIGRAM, function=distance_linear),
